...
class Settings:
    ...
    model_default: str = os.getenv("OLLAMA_MODEL_DEFAULT", "llama3.1:8b")
    model_reasoning: str = os.getenv("OLLAMA_MODEL_REASONING", "llama3.1:8b")
    model_coder: str = os.getenv("OLLAMA_MODEL_CODER", "qwen2.5-coder:7b")
    model_fast: str = os.getenv("OLLAMA_MODEL_FAST", "gemma2:2b")
